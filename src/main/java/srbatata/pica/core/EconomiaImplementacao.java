...
public record EconomiaImplementacao(GerenciadorDeContas dados) implements Economy {
    ...
    */
    ...
    public EconomyResponse createBank(String name, String player) {
        return new EconomyResponse(0, 0, EconomyResponse.ResponseType.NOT_IMPLEMENTED, "Bancos desativados");
    }
